''':arg
this pattern allow to add new features to an existing class hierarchy without changing it

visitor type 1  = PLUMBER
Visitor type 2 = electrician

basically new operation is performed to various element of an existing class hierarchy
'''
